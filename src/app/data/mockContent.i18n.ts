...
export const keynoteSpeakersI18n: Record<Locale, KeynoteSpeaker[]> = {
  ...
  en: [
    ...
    },
    {
      ...
      topic: 'End-to-end security in CI/CD pipelines.',
      topicSecondLine: 'Software supply chain security.',
      imageSrc: '/images/speakers/keynotes/xavier_rene.jpeg',
      imagePosition: 'center bottom',
      imageFit: 'contain',
...
export const invitedSpeakersI18n: Record<Locale, InvitedSpeaker[]> = {
  ...
  en: [
    { name: 'Jimmy Florez',        role: 'DevSecOps Lead at NEQUI',                                                            country: 'Colombia',  topic: 'From DevOps to Platform Engineering: The Journey',                                                                                       imageSrc: '/images/speakers/speakers/jimmy_florez.png',          alt: 'Jimmy Florez, invited speaker at DevOpsDays Lima' },
    { name: 'Juan Arguello',       role: 'Open Source Office Lead at BANCOLOMBIA',                                             country: 'Colombia',  topic: 'From OpenClaw to EnterpriseClaw: Platform Engineering Evolving Toward Agent Orchestration.',                                             imageSrc: '/images/speakers/speakers/juan_arguello.png',         alt: 'Juan Arguello, invited speaker at DevOpsDays Lima' },
    { name: 'Andrea Griffiths',    role: 'Senior Developer Advocate at GITHUB',                                                country: 'Colombia',  topic: 'Agents in Production: What I Had to Learn After Automating Everything',                                                                  imageSrc: '/images/speakers/speakers/andrea_griffiths.png',      alt: 'Andrea Griffiths, invited speaker at DevOpsDays Lima' },
    ...
    { name: 'Yury Niño',           role: 'Cloud Application Engineer at GOOGLE',                                               country: 'Colombia',  topic: 'STPA Applied to DevOps & SRE',                                                                                                           imageSrc: '/images/speakers/speakers/yury_nino.png',             alt: 'Yury Niño, invited speaker at DevOpsDays Lima' },
    { name: 'Emma Flores',         role: 'Digital Architecture Manager at NTT DATA',                                           country: 'Perú',      topic: 'From Automation to Operational Intelligence',                                                                                            imageSrc: '/images/speakers/speakers/emma_flores.png',           alt: 'Emma Flores, invited speaker at DevOpsDays Lima' },
    { name: 'Sebastian Rojas',     role: 'Field Software Engineer at CANONICAL',                                               country: 'Perú',      topic: 'Turning Bare Metal into Cloud: Deploy Any Physical Server with MAAS.',                                                                   imageSrc: '/images/speakers/speakers/sebastian_rojas.png',       alt: 'Sebastian Rojas, invited speaker at DevOpsDays Lima' },
    { name: 'Francisco Lopez',     role: 'Architecture & Strategy Director - Risk & Compliance at Royal Bank of Canada',       country: 'Perú',      topic: 'Train in the Cloud, Deploy at Home: Hybrid Enterprise Strategy for LLMs and ML Models.',                                               imageSrc: '/images/speakers/speakers/francisco_lopez.png',       alt: 'Francisco Lopez, invited speaker at DevOpsDays Lima' },
    { name: 'Ricardo Amarilla',    role: 'Senior Solutions Architect at GITLAB',                                               country: 'Paraguay',  topic: 'From Reactive to Proactive: Scaling DevSecOps with AI Agents.',                                                                         imageSrc: '/images/speakers/speakers/ricardo_amarilla .png',     alt: 'Ricardo Amarilla, invited speaker at DevOpsDays Lima' },
    { name: 'Angelo Leva',         role: 'GDG Lead at TRANZACT',                                                               country: 'Perú',      topic: 'Specs Before Prompts: Spec-Driven Development for Agentic Coding.',                                                                     imageSrc: '/images/speakers/speakers/angelo_leva.png',           alt: 'Angelo Leva, invited speaker at DevOpsDays Lima' },
    { name: 'Carlos Gallardo',     role: 'CTO at CLEVERIT',                                                                    country: 'Chile',     topic: 'The AI Orchestrator and How SDLC Must Change.',                                                                                          imageSrc: '/images/speakers/speakers/carlos_gallardo.png',       alt: 'Carlos Gallardo, invited speaker at DevOpsDays Lima' },
    { name: 'Victor Alvarez',      role: 'Systems Reliability Officer at Scotiabank',                                          country: 'Perú',      topic: 'From Reaction to Resilience: Scaling SRE from Incident to Executive Decision.',                                                         imageSrc: '/images/speakers/speakers/victor_alvarez.png',        alt: 'Victor Alvarez, invited speaker at DevOpsDays Lima' },
    { name: 'Martin Grados',       role: 'Head of GenAI at MINSUR',                                                            country: 'Perú',      topic: 'AI Is Coming for Our Jobs and That\'s Good News.',                                                                                       imageSrc: '/images/speakers/speakers/martin_grados.png',         alt: 'Martin Grados, invited speaker at DevOpsDays Lima' },
    { name: 'Andre Delgado Ruiz',  role: 'Lead DevOps Operations at YAPE',                                                     country: 'Perú',      topic: 'DevOps: The Human Side of Operations.',                                                                                                  imageSrc: '/images/speakers/speakers/andre_delgado.png',         alt: 'Andre Delgado Ruiz, invited speaker at DevOpsDays Lima' },
  ],
}
