export type HeroSectionLocale = 'es' | 'en'

type GalleryImageCopy = {
  alt: string
...
type HeroSectionCopy = {
  ...
  galleryImages: GalleryImageCopy[]
}

const heroSectionCopy: Record<HeroSectionLocale, HeroSectionCopy> = {
  es: {
    ...
    galleryImages: [
      {
        ...
        openAriaLabel:
          'Abrir imagen del hero. Comunidad DevOpsDays Lima 2025 reunida con letras LIMA - Primera edición',
      },
      {
        alt: 'Presentación keynote en auditorio DevOpsDays Lima con speaker en escenario principal',
        openAriaLabel:
          'Abrir imagen del hero. Presentación keynote en auditorio DevOpsDays Lima con speaker en escenario principal',
      },
      {
        alt: 'Speaker presentando en DevOpsDays Lima con audiencia tech profesional',
        openAriaLabel:
          'Abrir imagen del hero. Speaker presentando en DevOpsDays Lima con audiencia tech profesional',
      },
      {
        alt: 'Audiencia DevOpsDays Lima enfocada en charla técnica sobre DevOps',
        openAriaLabel:
          'Abrir imagen del hero. Audiencia DevOpsDays Lima enfocada en charla técnica sobre DevOps',
      },
    ],
  },
  en: {
    ...
    galleryImages: [
      {
        ...
        openAriaLabel:
          'Open hero image. DevOpsDays Lima 2025 community gathered around the LIMA letters - first edition',
      },
      {
        alt: 'Keynote presentation in the DevOpsDays Lima auditorium with a speaker on the main stage',
        openAriaLabel:
          'Open hero image. Keynote presentation in the DevOpsDays Lima auditorium with a speaker on the main stage',
      },
      {
        alt: 'Speaker presenting at DevOpsDays Lima with a professional tech audience',
        openAriaLabel:
          'Open hero image. Speaker presenting at DevOpsDays Lima with a professional tech audience',
      },
      {
        alt: 'DevOpsDays Lima audience focused on a technical DevOps talk',
        openAriaLabel:
          'Open hero image. DevOpsDays Lima audience focused on a technical DevOps talk',
      },
    ],
  },
}

export function getHeroSectionLocale(locale?: string): HeroSectionLocale {
  return locale?.toLowerCase().startsWith('en') ? 'en' : 'es'
}

export function getHeroSectionCopy(locale?: string): HeroSectionCopy {
  return heroSectionCopy[getHeroSectionLocale(locale)]
}
