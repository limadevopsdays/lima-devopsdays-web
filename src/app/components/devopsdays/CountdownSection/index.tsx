...
import { countdownI18n } from './i18n'
      ...
      <div className={styles.container}>
        <div className={styles.inner}>
          ...
          <div className={styles.message}>
            ...
            <div>
              {isEventStarted ? (
                <p className={styles.messageTitle}>{t.eventStarted}</p>
              ) : (
                <p className={styles.messageTitle}>{t.eventSoon}</p>
              )}
            </div>
          </div>
