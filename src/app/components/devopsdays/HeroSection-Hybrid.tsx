...
// ─── Component ────────────────────────────────────────────────────────────────
export function HeroSectionHybrid() {
  return (
    <section
      id="hero"
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {/* Líneas diagonales sutiles - Morado */}
        <div
        ...
        {/* Líneas diagonales sutiles inversas - Turquesa */}
        <div
          className="absolute inset-0 opacity-[0.04]"
          style={{
            backgroundImage: 
              'repeating-linear-gradient(-45deg, transparent, transparent 80px, #06b6d4 80px, #06b6d4 81px)',
          }}
        />
        
        {/* Puntos dispersos - Multicolor */}
        <div
        ...
        {/* Puntos secundarios desplazados - Turquesa */}
        <div
