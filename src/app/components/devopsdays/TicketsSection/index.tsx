  ...
  return (
    ...
    >
      <div className={styles.container}>
        <SectionHeader
          eyebrow={variant === 'page' ? undefined : t.eyebrow}
                ...
                <div className={styles.ticketHeader}>
                  ...
                  <div className={styles.ticketMeta}>
                    <div className={styles.ticketDate}>
                      ...
                      <div className={styles.ticketDateMonth}>{t.ticketDateMonth}</div>
                    </div>
                ...
                <div className={styles.ticketPricing}>
                  ...
                  {!vipSoldOut && !pricingAnnounced && (
                    <div className={styles.comingSoonBlock}>
                      ...
                      <div className={styles.priceValidity}>
                        ...
                        {t.saleStart(TICKET_SALE_START_LABEL)}
                      </div>
                    </div>
                  )}
                  ...
                  {!vipSoldOut && pricingAnnounced && (
                    <>
                      ...
                      <div className={styles.priceValidity}>
                        <Clock className={styles.validityIcon} />
                        {t.saleStarted(TICKET_SALE_START_LABEL)}
                      </div>
                    </>
                  )}
                </div>
