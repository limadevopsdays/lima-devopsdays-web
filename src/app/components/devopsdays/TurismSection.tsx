...
const places: Place[] = [
  {
    src: '/images/tourism/plaza-de-armas.jpg',
    name: 'Plaza de Armas',
  ...
  {
    src: '/images/tourism/barranco.jpg',
    name: 'Barranco',
  ...
  {
    src: '/images/tourism/larcomar.jpeg',
    name: 'Larcomar',
  ...
  {
    src: '/images/tourism/barrio-chino.jpeg',
    name: 'Barrio Chino',
  ...
  {
    src: '/images/tourism/parque-del-amor.png',
  ...
  {
    src: '/images/tourism/paque-de-las-aguas-2.webp',
  ...
  {
    src: '/images/tourism/plaza-de-armas-2.jpg',
        ...
        <div className={styles.mpCallout}>
          ...
          <div className={styles.mpContent}>
            ...
            <p className={styles.mpDesc}>
              Aprovecha tu viaje a Perú y visita la ciudadela inca más famosa del mundo. Una de las 7 maravillas del
              mundo moderno que no puedes dejar de ver.
            </p>
            <a
        ...
        {active && activeIndex !== null && (
          ...
          >
            ...
            >
              ...
              <button onClick={() => setActiveIndex(null)} className={styles.closeButton} aria-label="Cerrar">
                <X size={20} />
              </button>
