...
export function VenueSection() {
  ...
  const t = useI18n(venueI18n)
  const transit = useI18n(venueTransitI18n)
  const features = useI18n(venueFeaturesI18n).map((f) =>
    f.type === 'stat'
      ? { value: f.value, label: f.label }
      : { value: f.flagText, label: f.label }
  )
      ...
      <div className={styles.container}>
        ...
        <div className={styles.mainGrid}>
          ...
          <div className={styles.infoPanel}>
            {/* Name + address + CTA */}
            <div>
              <h2 className={styles.venueTitle}>{t.venueName}</h2>
            ...
            <div className={styles.twoColGrid}>
              {/* Transport */}
              <div>
                <p className={styles.sectionLabel}>{t.howToGetThere}</p>
              ...
              {/* Stats */}
              <div>
                <p className={styles.sectionLabel}>{t.installations}</p>
            ...
            {/* Gallery */}
            <div>
              <p className={styles.sectionLabel}>{t.gallery(venue.photos.length)}</p>
