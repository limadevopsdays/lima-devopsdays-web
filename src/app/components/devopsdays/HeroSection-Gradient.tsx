...
export function HeroSectionGradient() {
  return (
    ...
    >
      {/* Background decoration - GRADIENTE MESH */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div
          className="absolute -top-32 -left-32 w-[700px] h-[700px] rounded-full opacity-[0.2]"
          style={{ 
        ...
        />
        <div
          className="absolute top-1/4 left-1/3 w-[500px] h-[500px] rounded-full opacity-[0.18]"
          style={{ 
        ...
        />
        <div
          className="absolute bottom-0 right-0 w-[600px] h-[600px] rounded-full opacity-[0.15]"
          style={{ 
        ...
        />
        <div
          className="absolute bottom-1/4 left-1/2 w-[450px] h-[450px] rounded-full opacity-[0.14]"
          style={{ 
        ...
        />
        <div
          className="absolute top-1/2 right-1/4 w-[400px] h-[400px] rounded-full opacity-[0.12]"
          style={{ 
