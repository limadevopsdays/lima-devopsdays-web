  ...
  return (
    ...
    >
      <div className="card sponsorBox">
        <div className="sponsorBox__tiers" role="list" aria-label={t('sponsors.tiersLabel')}>
          {sponsors.map((tier) => {
            ...
            return (
              ...
              >
                ...
                {tier.items.length > 0 ? (
                  <div className="sponsorTier__names" role="list" aria-label={t('sponsors.logosLabel', { tier: tierName })}>
      ...
      <div className="card sponsorCta">
        ...
        <div className="sponsorCta__actions">
          <div className="sponsorCta__brochures" aria-label={t('sponsors.brochureLabel')}>
            <Button
              as="a"
