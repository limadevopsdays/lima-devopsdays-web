...
const FooterSocialIcon = ({ icon }: { icon: 'linkedin' | 'instagram' }) => {
  if (icon === 'linkedin') {
    return (
      <svg className="footer__socialIconImg" width="18" height="18" viewBox="0 0 19 18" aria-hidden="true" focusable="false">
        <path
          fill="currentColor"
  ...
  return (
    <svg className="footer__socialIconImg" width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <path
        fill="currentColor"
